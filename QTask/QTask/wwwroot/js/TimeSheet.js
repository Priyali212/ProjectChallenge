$(document).ready(function () {
    ...
    ShowTimesheetList($('#txtSelectDate').val(), 1);

});
$(function () {
    $("#ddlPageList").on("change", function () {
        if (!isNaN($(this).val())) {
            ShowTimesheetList($('#txtSelectDate').val(), $(this).val());
        }
    });
});
...
$('#txtSelectDate').change(function () {
    ...
    ShowTimesheetList(WorkedDate, 1);
});
function ShowTimesheetList(WorkedDate, PageIndex) {
    var TotalPageCount = "";
    var PreviousPageIndex = "";
    var NextPageIndex = "";
    var url = apiUrl + 'TimesheetAPI/ShowTimesheetList';
    var TotalHours = 0.00;
    $.get(url, { WorkedDate: WorkedDate, PageIndex: PageIndex }, function (resonse) {
        if (resonse != null) {
    ...
    if (PreviousPageIndex >= 0) {
        paginationHtml += "    <a href=\"javascript:void(0);\" class=\"lft-btn\" onclick=\"ShowTimesheetList(" + PreviousPageIndex + ")\">";
    ...
    if (NextPageIndex >= 0) {
        paginationHtml += "    <a href=\"javascript:void(0);\" class=\"rgt-btn\" onclick=\"ShowTimesheetList(" + NextPageIndex + ")\">Next";
